...
-(void)layoutSubviews
{
    ...
    _leftTL.frame = CGRectMake(2, 0, CGRectGetWidth(self.frame)/2, CGRectGetHeight(self.frame));
    _rightTL.frame = CGRectMake(CGRectGetWidth(self.frame)/2-2, 0, CGRectGetWidth(self.frame)/2, CGRectGetHeight(self.frame));
    _leftTL.font = [UIFont systemFontOfSize:CGRectGetHeight(self.frame)/2];
    _rightTL.font = [UIFont systemFontOfSize:CGRectGetHeight(self.frame)/2];
