...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([cell isKindOfClass:[MyInfoTableViewCell class]]) {
        ...
        if ([title isEqualToString:_cellTitles[0]]) {
            ...
            ModifyUserBirthdayViewController *modifyUserBirthdayVC = [[ModifyUserBirthdayViewController alloc] initWithNibName:@"ModifyUserBirthdayViewController" bundle:nil];
            modifyUserBirthdayVC.userBirthdayBlock = ^(NSString *birthday) {
                [self.tableView reloadData];
            };
            [self.navigationController pushViewController:modifyUserBirthdayVC animated:YES];
