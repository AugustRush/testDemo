...
+ (UIImage *)imageForMatrix:(QRMatrix *)matrix {
  ...
  CGContextRef c = CGBitmapContextCreate(bytes, width, height, 8, 4 * width, colorSpace, kCGBitmapByteOrder32Big | kCGImageAlphaPremultipliedLast);
...
+ (UIImage *)encode:(NSString *)str {
  return [QREncoder encode:str size:2 correctionLevel:QRCorrectionLevelHigh];
}
